...
#define POT_VALUE_MAX 1000 // potentiometer reading when motor shaft is at 180 degree position. 
//You will need to fill this value according to your setup.See below....

#define POT_VALUE_MIN 20//potentiometer reading when when motor shaft is at 0 degree position. 
//You will need to fill this value according to your setup.See below....
...
#define PERM_ERROR 25 //the max permissible error in degrees. In my potentiometer, a turn only about 3 degrees
...
#define MAX_ANGLE 120 //we will allow our motor to turn by a maximum angle of 180 degrees
//**********************************
...
{
  //forwards turning..........
  for (int i = 30; i <= 100; i += 15) //our motor will turn from 30 to 150 degrees in steps of 15 degrees
  {
    customServo.GoToAngle(i, turnSpeed);
  }

  //backwards turning..........
  for (int i = 100; i >= 30; i -= 15) //now turn from 150 to 30 degrees in steps of 15 degrees
  {
    customServo.GoToAngle(i, turnSpeed);
  }
}
