...
if isWindows64():
      ...
      print('TurtleTk %s (Run on python %s:20a20b02a02, Feb 02 2020, 20:20:20) [MSC v%s 32 bit (Intel)] on win32/osx_linux64) ' % (tt_version, version[0:5], tt_version))
...
def demo():
      #create_canvas(color = 'blue')
      #create_line(-100, -100, 100, 100)
      #create_rectangle(-100, -100, 100, 100)
      #create_triangle(0, 0, 100, 200, 200, 220)
      #create_triangle(0, 0, 0, 0, 200, 220) #Error
      #create_text('Hiturtle!')
      #create_circle(0, 0, 125, thick = 25)
      #create_circle(0, 0, 75, fill = 'green')
      #create_semicircle(0, 0, 75)
      #create_semicircle(0, 0, 75, True)
      #create_polygon([[0, 0], [0, 100], [100, 100], [100, 0]])
      #random_rectangles()
      #one_random_rectangle()
      #random_polygon()
      pass
